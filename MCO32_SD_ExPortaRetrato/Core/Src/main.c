...
int main(void)
{
	...
	while(1)
	{
		...
		strcpy(nome, "Imagens/spacex1inv.bmp");
		...
		buffer[0] = 0;
		//Define o nome do arquivo BMP 24 bits a ser aberto
		strcpy(nome, "Imagens/spacex2inv.bmp");//strcpy(buffer, "Imagens/Lisa.bmp");
		//Abre o arquivo como leitura
		fr = f_open(&fsrc, nome, FA_READ);
		//Se teve sucesso
		if(fr == FR_OK)
		...
		buffer[0] = 0;
		//Define o nome do arquivo BMP 24 bits a ser aberto
		strcpy(nome, "Imagens/spacex3inv.bmp");//strcpy(buffer, "Imagens/Lisa.bmp");
		//Abre o arquivo como leitura
		fr = f_open(&fsrc, nome, FA_READ);
		//Se teve sucesso
		if(fr == FR_OK)
		...
		buffer[0] = 0;
		//Define o nome do arquivo BMP 24 bits a ser aberto
		strcpy(nome, "Imagens/spacex4inv.bmp");//strcpy(buffer, "Imagens/Lisa.bmp");
		//Abre o arquivo como leitura
		fr = f_open(&fsrc, nome, FA_READ);
		//Se teve sucesso
		if(fr == FR_OK)
